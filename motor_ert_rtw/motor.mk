###########################################################################
## Makefile generated for Simulink model 'motor'. 
## 
## Makefile     : motor.mk
## Generated on : Fri Sep 13 16:08:40 2019
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\motor.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Temps\BLPT\Softwares\soft-ware\DriverDown20190913
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = motor_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\motor.exe
...
INCLUDES_BUILDINFO = $(START_DIR)\motor_ert_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=motor -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\motor_ert_rtw\motor.c $(START_DIR)\motor_ert_rtw\motor_data.c
...
{$(START_DIR)\motor_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\motor_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
